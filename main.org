...
** Software Engineer {{{right-align(Index Exchange\, September 2021 - September 2024)}}}
:PROPERTIES:
:CUSTOM_ID: org-anchor-Software-Engineer-{{{right-align(Index-Exchange\,-September-2021---September-2024)}}}^1
:END:

- Worked on the core application API team, developing backend APIs in Go.
 - Incorporated technologies including Ansible and Redis.
- Practiced DevOps engineering using Docker, Kubernetes, Helm, GitLab CI/CD and ArgoCD.
