...
** Sessional faculty {{{right-align(McMaster University\, 2013 - Present)}}}
:PROPERTIES:
...
- Participating in the McMaster Faculty of Engineering
  Graduate Mentorship Progam, mentoring a new graduate student,
  for the school year starting September 2020.
